            ...
            {recipes.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-20">
                    ...
                    <p className="mt-3 text-gray-500 dark:text-gray-400 text-center max-w-md">
                        No recipes are available in this category.
                    ...
                    {selectedCategory && (
                        <button
                            ...
                            className="mt-6 px-6 py-3 rounded-xl bg-orange-500 text-white font-medium hover:bg-orange-600 transition"
                        >
                            Show All Recipes
                        </button>
                    )}
                            ...
                            <div className="flex flex-col flex-grow p-6">
                                ...
                                <div className="mt-auto pt-6 flex flex-col gap-4 border-t border-gray-100 dark:border-gray-700/50">
                                    ...
                                    <Link
                                        ...
                                        className="relative flex items-center justify-center w-full px-4 py-3 bg-gray-900 hover:bg-gray-800 dark:bg-white dark:hover:bg-gray-100 text-sm font-semibold text-white dark:text-gray-900 rounded-xl transition-all"
                                    >
                                        View Recipe Details
                                    </Link>
                                </div>
