                ...
                <div className="grid grid-cols-2 md:grid-cols-3 items-center h-16">
                    ...
                    <div className="flex items-center">
                        <Link href="/" className="flex items-center gap-3 group">
                            <div className="w-10 h-10 rounded-full bg-gradient-to-r from-orange-500 to-red-500 flex items-center justify-center text-xl shadow-md transition-all duration-300">
                                🍳
                            </div>

                            <span className="text-xl md:text-2xl font-black tracking-tight text-gray-800 transition-all duration-300 group-hover:bg-gradient-to-r group-hover:from-orange-500 group-hover:to-red-500 group-hover:bg-clip-text group-hover:text-transparent">
                                RecipeHub
                            </span>
                        </Link>
                    </div>
